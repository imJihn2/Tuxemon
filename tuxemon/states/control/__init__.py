...
def reset_config_to_default() -> None:
    ...
    for button, key in default_controls.items():
        if (button != "backspace"):
            key_title_split = widget_list[button]._title.split(":",1) #####
            default_key = T.translate(key).upper() #####
            if (button == 'b'): #####
                default_key = T.translate("lshift").upper() #####
            key_title = key_title_split[0] + ": " + default_key #####
            widget_list[button]._title = key_title #####
    ...
    def process_event(self, event: PlayerInput) -> Optional[PlayerInput]:
        ...
        if (
            ...
            if event.value == pressed_key_str:
                new_key_str = self.client.active_states[0].selected_widget._title #####
                new_key_str = new_key_str.split(':',1)[0] #####
                new_key_str = new_key_str + ": " + T.translate(pressed_key_str).upper() #####
                self.client.active_states[0].selected_widget._title = new_key_str #####
...
class ControlState(PygameMenuState):
    ...
    def initialize_items(
        ...
        menu.add.button(
            title=T.translate("menu_up_key").upper() + " : " + T.translate(display_buttons[buttons.UP]).upper(), #####
            action=change_state(
        ...
        menu.add.button(
            title=T.translate("menu_left_key").upper() + " : " + T.translate(display_buttons[buttons.LEFT]).upper(), #####
            action=change_state(
        ...
        menu.add.button(
            title=T.translate("menu_right_key").upper() + " : " + T.translate(display_buttons[buttons.RIGHT]).upper(), #####
            action=change_state(
        ...
        menu.add.button(
            title=T.translate("menu_down_key").upper() + " : " + T.translate(display_buttons[buttons.DOWN]).upper(), #####
            action=change_state(
        ...
        menu.add.button(
            title=T.translate("menu_primary_select_key").upper() + " : " + T.translate(display_buttons[buttons.A]).upper(), #####
            action=change_state(
        ...
        menu.add.button(
            title=T.translate("menu_secondary_select_key").upper() + " : " + T.translate(display_buttons[buttons.B]).upper(), #####
            action=change_state(
        ...
        menu.add.button(
            title=T.translate("menu_back_key").upper() + " : " + T.translate(display_buttons[buttons.BACK]).upper(), #####
            action=change_state(
        ...
        widget_list = {} #####
        widget_list = { #####
            "up" : self.menu._widgets[0], #####
            "left" : self.menu._widgets[1], #####
            "right" : self.menu._widgets[2], #####
            "down" : self.menu._widgets[3], #####
            "a" : self.menu._widgets[4], #####
            "b" : self.menu._widgets[5], #####
            "back" : self.menu._widgets[6], #####
        }
